                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-6">
                      ...
                      <div className="flex justify-start">
                        <div className="max-w-md">
                          <div className="bg-white/70 backdrop-blur-sm border border-white/40 rounded-3xl p-4 shadow-lg">
                            <p className="text-sm text-slate-800 leading-relaxed">
                              Hi {getDisplayName()}, I wanted to follow up on our session today. 
                              How are you feeling about the homework we discussed?
                            </p>
                          </div>
                          <p className="text-xs text-slate-500 mt-2 ml-4 font-medium">2 hours ago</p>
                        </div>
                      </div>

                      <div className="flex justify-end">
                        <div className="max-w-md">
                          <div className="bg-gradient-to-r from-violet-500 to-purple-500 text-white rounded-3xl p-4 shadow-lg">
                            <p className="text-sm leading-relaxed">
                              I'm feeling much better about it now. The breathing exercises really helped 
                              during my anxiety episode yesterday.
                            </p>
                          </div>
                          <p className="text-xs text-slate-500 mt-2 mr-4 text-right font-medium">1 hour ago</p>
                        </div>
                      </div>
                      ...
                      <div className="flex justify-start">
                        <div className="max-w-md">
                          ...
                          <p className="text-xs text-slate-500 mt-2 ml-4 font-medium">30 minutes ago</p>
                        </div>
                      </div>
                    </div>
