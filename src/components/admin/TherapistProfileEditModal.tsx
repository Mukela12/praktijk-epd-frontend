  ...
  useEffect(() => {
    if (therapist) {
      setFormData({
        ...
        therapyTypes: Array.isArray((therapist as any).therapy_types) ? (therapist as any).therapy_types : [],
        languages: Array.isArray(therapist.languages) ? therapist.languages : [],
        bio: therapist.bio || '',
        qualifications: Array.isArray((therapist as any).qualifications) ? (therapist as any).qualifications : [],
