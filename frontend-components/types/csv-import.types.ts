// TypeScript interfaces for CSV import functionality
...
// Dutch field mappings verified against production database schema
...
// Alternative Dutch column names that might appear in CSV files
